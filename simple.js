...
docList = ["Why is documentation important?", "What is one of the first steps in code documentation?", "How do you figure out which components of code to document?", "Where is the best location to keep code documentation?"];
